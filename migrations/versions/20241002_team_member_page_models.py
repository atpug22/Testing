...
def upgrade():
    ...
    op.add_column("pull_requests", sa.Column("labels", postgresql.ARRAY(sa.String()), nullable=True))
    op.add_column("pull_requests", sa.Column("unresolved_comments", sa.Integer(), nullable=True, server_default="0"))
    op.add_column("pull_requests", sa.Column("lines_changed", sa.Integer(), nullable=True, server_default="0"))
    op.add_column("pull_requests", sa.Column("additions", sa.Integer(), nullable=True, server_default="0"))
    op.add_column("pull_requests", sa.Column("deletions", sa.Integer(), nullable=True, server_default="0"))
    op.add_column("pull_requests", sa.Column("changed_files", sa.Integer(), nullable=True, server_default="0"))
    ...
    op.add_column("pull_requests", sa.Column("first_commit_at", sa.DateTime(timezone=True), nullable=True))
    op.add_column("pull_requests", sa.Column("flow_blockers", postgresql.ARRAY(sa.String()), nullable=True))
    op.add_column("pull_requests", sa.Column("risk_flags", postgresql.ARRAY(sa.String()), nullable=True))
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.BigInteger(), nullable=False),
        sa.Column("primary_status", sa.String(length=50), nullable=False, server_default="balanced"),
        ...
        sa.Column("confluence_last_synced_at", sa.DateTime(timezone=True), nullable=True),
