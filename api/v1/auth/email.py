    ...
    try:
        async for db_session in get_session():
            try:
                ...
                # Create session
                from app.integrations.github_oauth import generate_session_id, set_session
                ...
                set_session(session_id, "", user_data)  # No GitHub token for email users
    ...
    try:
        async for db_session in get_session():
            try:
                ...
                existing_username_query = select(User).where(User.username == request.username)
