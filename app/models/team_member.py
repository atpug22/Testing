...
from sqlalchemy import BigInteger, Column, DateTime, Float, ForeignKey, Integer, String, Unicode, JSON
...
class TeamMember(Base, TimestampMixin):
    ...
    # === Work Focus Metrics ===
    work_focus_distribution = Column(JSON, nullable=True)  # {feature: 60%, bug: 30%, chore: 10%}
    ...
    copilot_insights = Column(JSON, nullable=True)  # [{type, signal, recommendation, priority}]
